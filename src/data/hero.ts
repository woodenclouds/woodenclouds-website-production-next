...
export const heroSlides: HeroSlide[] = [
  {
    image: "/assets/user/imgs/hero/hero-1.jpg",
  ...
  {
    image: "/assets/user/imgs/hero/hero-2.jpg",
    alt: "AI and insight",
  ...
  {
    image: "/assets/user/imgs/hero/hero-4.jpg",
    alt: "Digital future",
  ...
  {
    image: "/assets/user/imgs/hero/hero-3.jpg",
  ...
  {
    image: "/assets/user/imgs/hero/hero-collab.jpg",
    alt: "Dedicated teams",
