...
export const businessSupportOfferings = [
  {
    ...
    tagline: "Clarity before the next move",
    description:
      "Practical guidance on positioning, priorities, and decisions — so you spend energy on what actually moves the business.",
  },
  {
    title: "Market research",
    tagline: "Decisions grounded in reality",
    description:
      "Audience, competitor, and opportunity research that turns assumptions into a clearer path to market.",
  },
  {
  ...
  },
  {
    ...
    tagline: "Numbers that guide action",
    description:
      "Unit economics, runway thinking, and scenario planning so growth choices stay grounded in the math.",
  },
  {
  ...
  },
  {
    ...
    description:
      "A dedicated partner for the messy middle — reviews, course-corrections, and sustained momentum after the plan is set.",
  },
];
...
export const businessSupportProcess = [
  {
    index: "01",
    title: "Listen & map",
