...
$(function () {
    ...
    pageSection.each(function (indx) {
        ...
        if ($(this).attr("data-video")) {
            // If the element has a "data-video" attribute, set background video
            var videoSource = $(this).data("video");
            $(this).css({
                "background": "transparent", // Clear background image
                "position": "relative", // Ensure proper positioning for the video
            });
            $(this).prepend('<video autoplay muted loop playsinline style="width: 100%; height: 100%; position: absolute; top: 0; left: 0; object-fit: cover;"><source src="' + videoSource + '" type="video/mp4"></video>');
        }
    });
